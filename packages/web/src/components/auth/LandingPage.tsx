export function LandingPage() {
  return (
    <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
      ...
      <div className="relative z-20 mt-auto" data-testid="landing-page-quote">
        <blockquote className="space-y-2">
          <p className="text-lg">
            "This is the GraphQL and Relay boilerplate I've been using in my
            personal projects.”
          </p>
          <footer className="text-sm">LFSCamargo</footer>
        </blockquote>
      </div>
    </div>
  );
